...
namespace AirportSystem
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<AirlinesService>();
            services.AddTransient<FlightsService>();
            services.AddTransient<SeatsService>();
            services.AddDbContext<AirportDbContext>(options =>
            {
                options.UseMySql("server=localhost; port=3333; user=root; password=13355779; database=airport_system", new MySqlServerVersion(new System.Version(8, 0, 22)));
            });
        }
